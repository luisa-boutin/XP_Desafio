...
namespace XP_Projeto
{
    public partial class controleForm : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            ordensFechadasDataGridView.Columns[6].Width = 120;
        }
        ...
        {
            if (ordensAbertasDataGridView.Rows.Count > 0)
            {
